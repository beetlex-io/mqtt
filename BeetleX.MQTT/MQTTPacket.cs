...
{
    public class MQTTPacket<PARSE> : BeetleX.IPacket
        where PARSE : MQTTParse, new()
    {
        ...
        private PARSE mMQTTParse = new PARSE();

        public IPacket Clone()
        {
            return new MQTTPacket<PARSE>();
        }
    ...
    public class MQTTClientPacket<PARSE> : BeetleX.Clients.IClientPacket
        where PARSE : MQTTParse, new()
    {
        ...
        {
            return new MQTTClientPacket<PARSE>();
        }
