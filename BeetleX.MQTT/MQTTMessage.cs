...
namespace BeetleX.MQTT
{
    public abstract class MQTTMessage
    {
        ...
        protected virtual void OnWrite(Stream stream, ISession session)
        {

        }

        protected virtual void OnReadHeaders(Stream stream, ISession session) { }

        protected virtual void OnWriteHeaders(Stream stream, ISession session) { }
    }
}
