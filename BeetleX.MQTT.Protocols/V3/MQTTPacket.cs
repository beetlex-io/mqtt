...
{
    public class MQTTPacketV3 : BeetleX.IPacket

    {
        ...
        private MQTTParseV3 mMQTTParse = new MQTTParseV3();

        public IPacket Clone()
        {
            return new MQTTPacketV3();
        }
    ...
    public class MQTTClientPacketV3 : BeetleX.Clients.IClientPacket
